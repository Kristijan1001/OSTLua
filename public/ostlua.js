...
(function () {
  ...
  function closeDialog() { var o = document.querySelector(".hubcap-overlay"); if (o) o.remove(); }
  ...
  var lastUrl = "";
  function tick() {
    if (location.href !== lastUrl) { lastUrl = location.href; setTimeout(function () { ensureFab(); updateAllFabs(); }, 400); }
    else ensureFab();
  }
